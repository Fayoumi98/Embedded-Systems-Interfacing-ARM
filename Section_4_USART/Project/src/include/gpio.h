...
* Return value : void
*****************************************************************************/
void pin_config(GPIO_TypeDef *port,uint32_t pinNumber, uint32_t pinMode,uint32_t pull);
...
* Return value : void
*****************************************************************************/
void pin_speed_config(GPIO_TypeDef *port,uint32_t pinNumber, uint32_t speed);
